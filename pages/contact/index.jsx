...
import Enquary from '../../component/layouts/Enquary';
...
const Contact = () => {
  ...
  return (
    ...
    <button className='mt--15 fs--25 bg--error color--white pd--10 bg--radius bg--shadow mb--50' onClick={()=>setEnquiry(!enquiry)}>Enquiry</button>
      {enquiry && <Enquary/>}
    </div>
